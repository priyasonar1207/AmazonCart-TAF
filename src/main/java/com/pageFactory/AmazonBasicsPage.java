...
public class AmazonBasicsPage {
	...
	By loc_btnNextPage = By.xpath("//ul[@class='a-pagination']//li[@class='a-last']//a[contains(.,'Next')]");
	...
	//verify amazon basics page
		...
		public void clickOnNextPage(){
			objWrapperFunctions.setImplicitWait(10);
		...
		public boolean isSelectedProductHeaderIsDisplayed(){
			...
			try {
			objWrapperFunctions.setImplicitWait(3);
