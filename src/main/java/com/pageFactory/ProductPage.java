...
public class ProductPage {
	...
	By loc_hdrProduct = By.xpath("//h1[contains(.,'Amazon Basics 8-Sheet Capacity, Cross-Cut Paper and Credit Card Shredder, 4.1 Gallon')]");
	...
	//verify selected product page is displayed
			public void verifySelectedProductPageIsDisplayed() {
				BaseTest.driver.findElement(loc_hdrProduct).isDisplayed();
				Assert.assertTrue(BaseTest.driver.findElement(loc_hdrProduct).isDisplayed(),"Product header is not displayed");
			...
			public void verify8sheetSizeIsSelected(){
				...
				Assert.assertTrue(BaseTest.driver.findElement(loc_btnSize).isDisplayed(),
